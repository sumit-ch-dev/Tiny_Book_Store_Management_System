...
{
    public partial class Form6Manager_List : Form
    {
        ...
        public Form6Manager_List()
        {
            InitializeComponent();
            
        }
        private void Form6Manager_List_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "Select * from ManagerLogin";
                cmd.ExecuteNonQuery();
